...
typealias CombinationEntry = Pair<KClassPair, Combiner>

typealias KClassPair = Pair<KClass<*>, KClass<*>>

typealias Combiner = (Any, Any) -> Any

class CombinationsHandler private constructor(){
    companion object {
        private val combinations: Map<KClassPair, Combiner> = combiners()
        ...
        fun <S : Any, T : Any> valid(first: S, second: T) : Boolean = combinations.containsKey(KClassPair(first::class, second::class))
    }
}

private fun combinationPair(combiner: Combiner, first: KClass<*>, second: KClass<*> = first): CombinationEntry = Pair(KClassPair(first, second), combiner)
...
private fun combiners() : Map<KClassPair, Combiner> {
    ...
    return mapOf(
            ...
            *plusPairs(Int::class, Long::class, Float::class, Short::class, Integer::class, Double::class),
            ...
            combinationPair({ a, b -> Start(CombinationsHandler.combine(anyOperation(a).invoke(Any()), anyOperation(b).invoke(Any()))) }, Start::class),
